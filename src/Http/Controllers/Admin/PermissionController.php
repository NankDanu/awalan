...
class PermissionController extends Controller
{
    ...
    {
        return view('base::base.admin.permissions.index');
    }
    ...
    {
        return view('base::base.admin.permissions.create');
    }
    ...
    public function store(StorePermissionRequest $request): RedirectResponse
    {
        try {
            ...
            return back()->with('error', 'Gagal menambahkan permission: ' . $e->getMessage())->withInput();
        }
    }

    public function edit(Permission $permission): View
    {
        return view('base::base.admin.permissions.edit', ['permission' => $permission]);
    }
    ...
    public function update(UpdatePermissionRequest $request, Permission $permission): RedirectResponse
    {
        try {
            ...
            return back()->with('error', 'Gagal memperbarui permission: ' . $e->getMessage())->withInput();
        }
    }
    ...
    public function destroy(Permission $permission): RedirectResponse
    {
        try {
            ...
            return back()->with('error', 'Gagal menghapus permission: ' . $e->getMessage());
        }
    }
}
