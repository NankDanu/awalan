...
class RoleController extends Controller
{
    ...
    /**
     * Get roles for server-side datatable.
     */
    public function datatable(Request $request)
    {
        ...
        $rows = $payload['data']->map(function (Role $role): array {
            $permissions = $role->permissions->map(function ($permission): string {
                return '<span class="kt-badge kt-badge-light kt-badge-primary kt-badge-sm">' . e($permission->name) . '</span>';
            })->implode(' ');
