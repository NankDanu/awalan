    ...
    <div class="catat_document">
        <article class="space-y-6">
            ...
            <section class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                ...
                <pre class="rounded-lg bg-slate-900 px-4 py-3 text-sm text-emerald-300 overflow-x-auto"><code class="font-mono">&lt;?php echo &quot;Panel baru siap dipakai!&quot;;</code></pre>
            </section>
